...
exports.ERROR_NO_WEBHOOK_ID = exports.ERROR_NO_URL = void 0;
const api_base_1 = require("../api-base");
const Webhook_1 = require("../model/Webhook");
/** @hidden */
exports.ERROR_NO_URL = 'No URL provided';
/** @hidden */
exports.ERROR_NO_WEBHOOK_ID = 'No Webhook ID provided';
/**
...
class WebhooksService {
    ...
    static create(url) {
        if (!url || typeof url !== 'string') {
            throw new Error(exports.ERROR_NO_URL);
        }
        return api_base_1.default.request(`webhooks`, { url }, 'POST')
            .then((response) => new Webhook_1.default(response));
    }
    /**
     * Remove a webhook.
     *
     ...
     */
    static remove(webhook) {
        let webhookId = webhook instanceof Webhook_1.default ? webhook.id : webhook;
        if (!webhookId || typeof webhookId !== 'number') {
            throw new Error(exports.ERROR_NO_WEBHOOK_ID);
        }
        return api_base_1.default.request(`webhooks/${webhookId}`, undefined, 'DELETE');
    }
}
