 ...
 */
declare type DesiredQueuePosition = 'FIRST' | 'MIDDLE' | 'LAST';
/** This error is thrown when a Line ID is not passed to the API method, or when its type is not
 *  a number.
 *  @hidden */
export declare const ERROR_NO_LINE_ID: string;
/**
 * This error is thrown when the line is not a number (for the line ID) or a valid Line object.
 * @hidden
 */
export declare const ERROR_INVALID_LINE: string;
/** This error is thrown when the Ticket ID is not passed to the API method, or when its type is
 *  not a number.
 *  @hidden */
export declare const ERROR_NO_TICKET_ID: string;
/** @hidden */
export declare const ERROR_INVALID_TICKET: string;
/** This error is thrown when the Ticket Changes object is not passed to TicketService.edit.
 * @hidden */
export declare const ERROR_NO_TICKET_CHANGES: string;
/** This error is thrown when a user is not passed into API methods that take a user.
 * @hidden */
export declare const ERROR_NO_USER: string;
/** @hidden */
export declare const ERROR_INVALID_USER: string;
/** This error is thrown when the desired queue position is not passed into
 *  TicketService.returnToQueue.
 *  @hidden */
export declare const ERROR_NO_QUEUE_POSITION: string;
/** @hidden */
export declare const ERROR_INVALID_DESK: string;
export declare type TicketCreationParameters = Pick<Ticket, 'id' | 'source' | 'firstName' | 'lastName' | 'phoneNumber' | 'email' | 'extra'>;
export declare type TicketEditingParameters = Pick<Ticket, 'line' | 'phoneNumber' | 'firstName' | 'lastName' | 'email' | 'extra'> & {
    user: User | number;
};
declare type TicketCreationResponse = Pick<Ticket, 'id'>;
/**
...
export default class TicketService {
     ...
     */
    static callNext(lines: Array<Pick<Line, 'id'> | number>, user?: (User | number), desk?: (Desk | number), keepActiveTicketsOpen?: boolean): Promise<Ticket>;
    /**
     ...
     */
    static call(ticket: (Pick<Ticket, 'id'> | number | string), user?: (User | number), desk?: (Desk | number), keepActiveTicketsOpen?: boolean): Promise<Ticket>;
    /**
     * Recall a ticket.
     *
     ...
     */
    static returnToQueue(ticket: (Pick<Ticket, 'id'> | number | string), user: (User | number), position: DesiredQueuePosition): Promise<'success'>;
    /**
     ...
     */
    static assignToUser(ticket: (Pick<Ticket, 'id'> | number | string), assigner: (User | number), assignee: (User | number)): Promise<'success'>;
    /**
     ...
     */
    static sendMessage(ticket: (Pick<Ticket, 'id'> | number | string), message: string, user: (User | number)): Promise<'success'>;
    /**
     ...
     */
    static forward(ticket: (Pick<Ticket, 'id'> | number | string), line: (Line | number), user?: (User | number)): Promise<object>;
    /**
