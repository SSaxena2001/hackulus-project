 ...
 * ```
 */
export declare type TicketExtra = {
    title: string;
    value: string;
    url?: string;
};
 ...
 */
export declare type TicketInteraction = {
    start: string;
    end: string;
    line: number;
};
 ...
 */
export declare type TicketLabel = {
    value: string;
    color: string;
};
/**
 ...
 * ```
 */
export declare type TicketMessage = {
    created: {
        date: string;
    };
    body: string;
 ...
 */
export declare type TicketStatus = 'NEW' | 'CALLED' | 'CANCELLED' | 'CANCELLED_BY_CLERK' | 'NOSHOW' | 'SERVED';
